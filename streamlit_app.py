...
def trigger_clear_screen():
    """Temporarily show clearing screen, then rerun."""
...
# CASE 2: Map view
    ...
    with content_container:
        ...
        st.markdown("### 🗺️ Select your Area of Interest")
        ...
        if output and "all_drawings" in output and output["all_drawings"]:
            ...
            st.session_state.geojson_input = geojson_input
